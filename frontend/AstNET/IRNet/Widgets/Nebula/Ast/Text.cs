...
public struct Text : IFlatbufferObject
{
  ...
  public static Offset<Nebula.Ast.Text> CreateText(FlatBufferBuilder builder,
  ...
  public static void StartText(FlatBufferBuilder builder) { builder.StartTable(1); }
  public static void AddValue(FlatBufferBuilder builder, StringOffset valueOffset) { builder.AddOffset(0, valueOffset.Value, 0); }
  public static Offset<Nebula.Ast.Text> EndText(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Nebula.Ast.Text>(o);
  }
}
